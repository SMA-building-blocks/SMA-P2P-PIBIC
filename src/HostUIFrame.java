    ...
    extends JFrame
{
    ...
    JLabel lbl_networkState = new JLabel();
    Box box1;
    ...
    protected SetupAgent m_owner;


    // Constructors
    //////////////////////////////////

    public HostUIFrame( SetupAgent owner ) {
        try {
            jbInit();
        }
        catch(Exception e) {
...
//        });
        ...
        jLabel4.setText("Guests who have the info: ");
        lbl_networkState.setBackground(Color.white);
        lbl_networkState.setText("Not started");
        ...
        pnl_main.add(lbl_networkState, null);
        ...
        lbl_networkState.setForeground( Color.black );
    ...
    void btn_start_actionPerformed(ActionEvent e) {
        ...
        m_owner.addBehaviour( new OneShotBehaviour() {
                                  public void action() {
                                      ((SetupAgent) myAgent).createPeers( slide_numPeers.getValue() );
                                  }
                              } );
    }
...
//    }
    ...
    void enableControls( boolean starting ) {
        ...
        slide_numPeers.setEnabled( !starting );
...
//        m_owner.addBehaviour( new OneShotBehaviour() {
//                                  public void action() {
//                                      ((SetupAgent) myAgent).terminateHost();
//                                  }
//                              } );
//    }
